...
%  =========================================================================
%  Loads an already-preprocessed volume Y from a .mat file. When the file or
%  variable presets are empty, a file dialog and an entry picker are shown so
%  the correct variable can be chosen from the file's contents.
%
...
cfg.io.output_root         = [];   % extra artifact root ([] = pwd; logs still go to the project folder)
