function [] = init_mcsbd( mode, setdefconfig )
%INIT_MCSBD   Initializes subdirectories and default config settings.
%
%   Optional arguments:
...
%   run_entrance/scripts/{real,synthetic,phase_space,tool}/.
    ...
    scripts_root = fullfile(fp, 'run_entrance', 'scripts');
